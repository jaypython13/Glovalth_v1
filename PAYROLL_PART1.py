...
if choice == "Task Completion Form":
	...
	with st.form("form1", clear_on_submit = True):
		...
		activity = col1.selectbox("Task",  placeholder = "Choose your Task activity here", ("Medication Administration", "Assist with meal preparation", "Vital Signs Monitoring", "Transportation and Errands", "Housekeeping", "Wound Care", "Assistance with Medical Devices", "Mobility Assistance", "Personal Care with Medical Focus","personal Hygiene", "Emotional Support"))
