...
if choice == "Login/Sign Up":
	st.header(":blue[We are Working on It! Thank you for your interest in our product. We are currently fine-tuning this feature to provide you with the best experience possible. Please check back soon!]")
