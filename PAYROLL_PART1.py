...
choice = option_menu(None, ["Home", "Login/Sign Up", "Employee Work Management Portal", "Task Completion Form", 
	...
	styles={
        ...
        "nav-link": {"font-size": "15px", "text-align": "center", "margin":"10px", "--hover-color":  "#000000","margin-color":"blue"},
